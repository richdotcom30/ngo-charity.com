...
<a class="w-10 h-10 rounded-full bg-[#1e2f1b] flex items-center justify-center text-white hover:bg-primary hover:text-black transition-colors" href="#">
...
<input class="bg-[#1e2f1b] border border-[#2d4625] rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-primary placeholder-gray-500 w-full" placeholder="Your email address" type="email"/>
<button class="bg-white text-black font-bold py-3 rounded-xl hover:bg-primary transition-colors text-sm" type="button">
                        Subscribe
                    </button>
</form>
</div>
