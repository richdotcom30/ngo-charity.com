...
<button class="flex items-center justify-center rounded-full h-12 px-8 bg-primary hover:scale-105 transition-transform text-[#152112] text-base font-bold">
<span class="mr-2">Explore Causes</span>
<span class="material-symbols-outlined text-sm font-bold">arrow_downward</span>
</button>
<button class="flex items-center justify-center rounded-full h-12 px-8 bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-colors text-white text-base font-bold">
...
<button class="flex h-10 items-center justify-center gap-x-2 rounded-full bg-primary text-[#152112] px-5 transition-all hover:scale-105 shadow-[0_0_10px_rgba(76,223,32,0.3)]">
<span class="material-symbols-outlined text-[20px]">grid_view</span>
<span class="text-sm font-bold">All Causes</span>
</button>
<button class="flex h-10 items-center justify-center gap-x-2 rounded-full bg-[#2d4625] hover:bg-[#3d5c33] px-5 transition-all hover:text-white group">
...
<!-- Card 1: Water -->
<div class="group flex flex-col bg-[#20321b] rounded-2xl overflow-hidden hover:-translate-y-2 transition-all duration-300 hover:shadow-glow border border-[#2d4625]">
...
<div class="flex gap-3">
<button class="flex-1 h-10 bg-primary hover:bg-white hover:text-black text-[#152112] font-bold rounded-full text-sm transition-colors">Donate Now</button>
<button class="h-10 w-10 flex items-center justify-center rounded-full border border-[#2d4625] text-white hover:border-primary hover:text-primary transition-colors">
<span class="material-symbols-outlined">arrow_forward</span>
</button>
</div>
...
<button class="flex items-center gap-2 text-white font-medium hover:text-primary transition-colors">
