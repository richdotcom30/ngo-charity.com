...
<!-- Stats -->
<section class="py-10 px-4 md:px-10 lg:px-20 xl:px-40">
<div class="max-w-[1200px] mx-auto">
...
<p class="text-text-secondary text-sm font-medium uppercase tracking-wider">Volunteers Mobilized</p>
...
<p class="text-text-secondary text-sm font-medium uppercase tracking-wider">Hours Donated</p>
...
<p class="text-text-secondary text-sm font-medium uppercase tracking-wider">Lives Impacted</p>
...
<section class="py-10 px-4 md:px-10 lg:px-20 xl:px-40" id="opportunities">
<div class="max-w-[1200px] mx-auto">
...
<p class="text-text-secondary">Find a role that fits your skills and schedule.</p>
</div>
...
<div class="flex items-center gap-1 text-text-secondary text-sm mb-3">
...
<p class="text-text-secondary text-sm">Start your journey in 3 easy steps.</p>
<!-- Progress Bar -->
...
<span class="absolute left-4 top-1/2 -translate-y-1/2 text-text-secondary material-symbols-outlined">person</span>
<input class="w-full bg-surface-dark border border-surface-highlight text-white text-sm rounded-xl pl-12 pr-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-text-secondary/50" placeholder="Full Name" type="text"/>
</div>
<div class="relative group">
<span class="absolute left-4 top-1/2 -translate-y-1/2 text-text-secondary material-symbols-outlined">email</span>
<input class="w-full bg-surface-dark border border-surface-highlight text-white text-sm rounded-xl pl-12 pr-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-text-secondary/50" placeholder="Email Address" type="email"/>
</div>
<div class="relative group">
<span class="absolute left-4 top-1/2 -translate-y-1/2 text-text-secondary material-symbols-outlined">call</span>
<input class="w-full bg-surface-dark border border-surface-highlight text-white text-sm rounded-xl pl-12 pr-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-text-secondary/50" placeholder="Phone Number" type="tel"/>
</div>
</div>
<div class="pt-2">
...
<p class="text-text-secondary">Hear from the people who make it all possible.</p>
</div>
...
<p class="text-text-secondary text-sm">Sydney Volunteer</p>
</div>
</div>
...
<p class="text-text-secondary text-sm">Remote Coordinator</p>
</div>
</div>
<p class="text-white/90 italic leading-relaxed">
...
<p class="text-text-secondary text-sm">Event Support</p>
</div>
</div>
<p class="text-white/90 italic leading-relaxed">
...
<!-- FAQ Section -->
<section class="py-16 px-4 md:px-10 lg:px-20 xl:px-40">
...
<div class="px-5 pb-5 text-text-secondary text-sm leading-relaxed">
