...
<img alt="Volunteers planting trees in Australian bushland" class="w-full h-full object-cover opacity-60" data-alt="Volunteers planting trees in Australian bushland" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDZXv0iL6OLQYx6gEGfl0LqMeQnwUH70AR7t1Nhg96HCMY61XaT3y47yAxtQoEfYNRM93ZJplZqC_H37Sd4c3NA3xWHXpBTPfK8jZJ1nrFGstloHqu7QeQbA-z20HFVV_WfhD2WvP2qiuA0kgIuaza_NTl8bXLk6ZxdGnmAld8iau9_UYMG1XpHzzWkZKbRkhAw1dwq4dD63Y8_JIWjJny0V_N4CxoFnZ0-SiQJ-Tgb3oSThQ4SaBUMQFC9s1QxrSUSc8bRns98YLU"/>
</div>
...
<div class="flex items-center justify-center w-10 h-10 rounded-lg bg-primary/20 text-primary border border-primary/30 backdrop-blur-sm">
...
<p class="text-lg text-gray-300 font-medium leading-relaxed">
                        Join our community of over 50,000 changemakers across Australia dedicated to preserving our unique environment.
                    </p>
<div class="flex items-center gap-4 mt-4">
<div class="flex -space-x-3">
<img alt="Member Avatar" class="w-10 h-10 rounded-full border-2 border-[#152111]" data-alt="Portrait of a smiling community member" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCq54bGRkbTjJNDZMNKkuSlKDM4t64HscN2HSNcU-kHbpwqTTDdadOpwjaMKGzJPghELsdbn77NGUFqB5ZzTg8EQgEjK5AxVXxAdyVWmR6CIqFYps3daa8ajiMbWFqW4vxzAkzYyt4fQ3mKZ7ZDlAjfFRH3UFvxVgG0mbFO3Yqb7zNYPmq_4PYjwuM_YmM9uAlgNbr2Tjn6ANzhVjDZeDaD02lb8zVEEwLGRT-H3HiXZRy4X8VmispzwYDe7eDbQlOtxiwLEcudc68"/>
<img alt="Member Avatar" class="w-10 h-10 rounded-full border-2 border-[#152111]" data-alt="Portrait of a young volunteer" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDBrF7XBCgr5LpHQ-sdKwmU3zgaIq9SBYOuvDjJzxApA9H85YtmgEeYBvikzeAPIaBD2rtsw9Z4paRNf76T1DElEBDj4UOXcxDT3R94VC6XzfPyrJzNNg68G-zxXehqTsLB9gcOzBTz2pBeZYd_JrnA2ouLN44V2YkDb0GuDI4AKIJic3L04PHvIr6Kavq0s536NJmi1kvbkgF-Wz59p3hIWbegv_XA5h4u4NZEsXm2GzP0uvb11j1ZNKH_4inEDFu1NY-QCl5CdRo"/>
<img alt="Member Avatar" class="w-10 h-10 rounded-full border-2 border-[#152111]" data-alt="Portrait of a senior donor" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCTdcGnkLT_wkH_QdH8zJGbCDcUhwGf9ESkzqp9F_nylrMTwoa_Hivp2mS1-mcCdxe8uLcESydI2vZopeo3jBLiZeRg1-aSJSJncfZ822JQ_3UcUx7ViCu-YkI7zm4IL28q49ZnExPf_afXazrjPGss3LGbBPFHtJWZCMf7W458KTRjtEfKjBrXRkN9rT7-bdt4etp1SX0JqhIHmk8hqND2z88B5se1lPQziRzsXZ-pTCBPcnF3jc34sV3P7eXEgWydTBpOl1VRWQM"/>
</div>
...
<div class="w-full max-w-[480px] bg-[#1a2c17]/60 dark:bg-[#1a2c17]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden p-8 md:p-10 flex flex-col gap-8 transition-all duration-500 ease-out transform translate-y-0 opacity-100">
<!-- Form Header -->
<div class="flex flex-col gap-2 text-center md:text-left">
<h2 class="text-3xl font-bold text-white tracking-tight">Welcome Back</h2>
<p class="text-gray-400 text-sm md:text-base">Enter your details to access your impact dashboard.</p>
</div>
<!-- Social Login -->
<div class="flex flex-col gap-3">
<button class="flex items-center justify-center gap-3 w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-lg h-12 transition-all duration-200 font-medium text-sm group">
<svg class="w-5 h-5 text-white/80 group-hover:text-white transition-colors" fill="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<!-- Action Button -->
<button class="mt-2 w-full flex items-center justify-center rounded-lg bg-primary py-3.5 px-4 text-sm font-bold text-[#152112] shadow-sm hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-[#152112] transition-all transform active:scale-[0.98]" type="submit">
                            Log In
                        </button>
</form>
<!-- Footer -->
...
<p class="text-sm text-gray-400">
                            ...
                            <a class="font-bold text-primary hover:text-primary/80 transition-colors" href="#">Join the movement</a>
</p>
</div>
<!-- Mobile Only Footer Links -->
<div class="md:hidden flex justify-center gap-4 text-xs text-gray-500 mt-4 border-t border-white/5 pt-6">
<a href="#">Privacy</a>
