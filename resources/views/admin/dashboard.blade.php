...
<a class="group flex items-center gap-3 px-3 py-3 rounded-lg bg-primary/10 text-primary dark:bg-primary/20 dark:text-white transition-all" href="{{ route('admin.dashboard') }}">
...
<p class="text-text-muted-light dark:text-text-muted-dark text-base">Here is what's happening with your organization today.</p>
</div>
<!-- Stats Grid -->
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
<!-- Stat Card 1 -->
<div class="bg-card-light dark:bg-card-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex flex-col relative group hover:border-primary/50 transition-colors">
...
<p class="text-text-muted-light dark:text-text-muted-dark text-sm font-medium mb-1">Total Donations</p>
<p class="text-2xl font-bold tracking-tight">$124,500</p>
</div>
<!-- Stat Card 2 -->
<div class="bg-card-light dark:bg-card-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex flex-col group hover:border-primary/50 transition-colors">
<div class="flex items-start justify-between mb-4">
...
<p class="text-text-muted-light dark:text-text-muted-dark text-sm font-medium mb-1">Active Volunteers</p>
...
<span class="flex items-center text-xs font-bold text-text-muted-light bg-gray-100 dark:bg-gray-800 dark:text-text-muted-dark px-2 py-1 rounded-full">
                                0%
                            </span>
</div>
<p class="text-text-muted-light dark:text-text-muted-dark text-sm font-medium mb-1">Programs Running</p>
...
<p class="text-text-muted-light dark:text-text-muted-dark text-sm font-medium mb-1">Lives Impacted</p>
...
<!-- Main Chart -->
<div class="xl:col-span-2 bg-card-light dark:bg-card-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex flex-col h-96">
<div class="flex items-center justify-between mb-6">
<h3 class="text-lg font-bold">Donations Overview</h3>
<select class="bg-background-light dark:bg-[#211911] border border-border-light dark:border-border-dark text-sm rounded-lg p-2 focus:ring-primary focus:border-primary">
...
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$12k</div>
</div>
<div class="w-full bg-primary/20 rounded-t-sm h-[45%] relative group">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$24k</div>
</div>
<div class="w-full bg-primary/30 rounded-t-sm h-[35%] relative group">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$18k</div>
</div>
<div class="w-full bg-primary/40 rounded-t-sm h-[60%] relative group">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$45k</div>
</div>
<div class="w-full bg-primary/30 rounded-t-sm h-[50%] relative group">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$32k</div>
</div>
<div class="w-full bg-primary/60 rounded-t-sm h-[75%] relative group">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$62k</div>
</div>
<div class="w-full bg-primary/80 rounded-t-sm h-[65%] relative group">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$58k</div>
</div>
<div class="w-full bg-primary rounded-t-sm h-[90%] relative group shadow-[0_0_15px_-3px_rgba(207,115,23,0.5)]">
<div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block bg-background-dark text-white text-xs py-1 px-2 rounded">$85k</div>
</div>
</div>
<!-- Y-axis lines -->
<div class="absolute inset-0 flex flex-col justify-between pointer-events-none text-text-muted-light dark:text-text-muted-dark/20 z-0">
...
<div class="flex justify-between mt-2 text-xs text-text-muted-light dark:text-text-muted-dark px-2">
<span>Jan</span><span>Feb</span><span>Mar</span><span>Apr</span><span>May</span><span>Jun</span><span>Jul</span><span>Aug</span>
</div>
</div>
<!-- Secondary Visual / Summary -->
<div class="xl:col-span-1 flex flex-col gap-6">
<div class="bg-card-light dark:bg-card-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex-1">
...
<div class="rounded-full size-40 relative shadow-xl" style="background: conic-gradient(#cf7317 0% 35%, #925110 35% 60%, #473624 60% 100%);">
<div class="absolute inset-0 m-auto size-24 bg-card-light dark:bg-card-dark rounded-full flex flex-col items-center justify-center">
<span class="text-2xl font-bold">450</span>
<span class="text-[10px] text-text-muted-light dark:text-text-muted-dark">Total</span>
</div>
</div>
</div>
...
<div class="p-6 border-b border-border-light dark:border-border-dark flex flex-col sm:flex-row sm:items-center justify-between gap-4">
<h3 class="text-lg font-bold">Recent Donations</h3>
<div class="flex items-center gap-2">
<button class="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-border-light dark:border-border-dark text-sm hover:bg-background-light dark:hover:bg-[#211911]">
...
<thead class="text-xs text-text-muted-light dark:text-text-muted-dark uppercase bg-background-light dark:bg-[#211911]/50 border-b border-border-light dark:border-border-dark">
<tr>
...
<div class="size-8 rounded-full bg-cover bg-center" data-alt="Portrait of James Wilson" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCv9vg9sHRbgoKprCn7crcZOQCuTt1g9uiXz9wCR9SQREEy66I_m5v980j-441c9NBxNKWkm8qUh7trJKFQRt-pNv_l6y0WmJlN4VamulT928CtXiHRBa6nfM4n8mQd59xQACp0ZxVhPKM-Lw8bExmRxxTmomFRGxnIxS7Kha2ARlDqzLmwS2jxHj6k6qosx1qOzRiZP0xeh3GtPvvBU89KEF6p4uwaBO6JT4dwoA_ige8-oYSusj98IZ5pjiFa1QESVpO0ulPFSyY");'></div>
                                        James Wilson
                                    </td>
<td class="px-6 py-4 text-text-muted-light dark:text-text-muted-dark">Bushfire Relief Fund</td>
<td class="px-6 py-4 text-text-muted-light dark:text-text-muted-dark">Oct 24, 2023</td>
<td class="px-6 py-4 font-bold text-text-main-light dark:text-text-main-dark">$500.00</td>
<td class="px-6 py-4">
<span class="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs px-2.5 py-0.5 rounded-full font-medium border border-green-200 dark:border-green-900/50">Completed</span>
</td>
...
<tr class="hover:bg-background-light dark:hover:bg-[#211911]/30 transition-colors">
<td class="px-6 py-4 font-medium text-text-main-light dark:text-text-main-dark flex items-center gap-3">
<div class="size-8 rounded-full bg-cover bg-center" data-alt="Portrait of Michael Chen" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAvWReFNTRic5D5ByoI_WNoRjVSgH0drDJx3Zwsk9UZI2BQWMyASdbHNzAdYS8hn2pkOywlAsfOzThv_Px8cfzCJ8iATHV-2lXv5WvNMSqbazpM7bc0nWIWb3ra-hfS2MmoXcj3X5Ga49GYt1azzHdZjaP9KO9FAQkcv7z9U3-MlBjou-TizMdSMetU0CSNr3elMHcI-UjZ54RWSb7ajeid3OjbMO8SgNSEWJQgSti4SZV_8MSTBiGhTdsQW__33LutpdeNnzAr5hM");'></div>
                                        Michael Chen
                                    </td>
<td class="px-6 py-4 text-text-muted-light dark:text-text-muted-dark">General Support</td>
<td class="px-6 py-4 text-text-muted-light dark:text-text-muted-dark">Oct 23, 2023</td>
<td class="px-6 py-4 font-bold text-text-main-light dark:text-text-main-dark">$2,500.00</td>
<td class="px-6 py-4">
<span class="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 text-xs px-2.5 py-0.5 rounded-full font-medium border border-yellow-200 dark:border-yellow-900/50">Pending</span>
</td>
<td class="px-6 py-4 text-right">
<button class="text-text-muted-light dark:text-text-muted-dark hover:text-primary transition-colors">
<span class="material-symbols-outlined">more_vert</span>
...
<span class="text-xs text-text-muted-light dark:text-text-muted-dark">Showing 4 of 128 transactions</span>
<div class="flex items-center gap-2">
<button class="p-1 rounded-md hover:bg-background-light dark:hover:bg-[#211911] text-text-muted-light dark:text-text-muted-dark disabled:opacity-50" disabled="">
<span class="material-symbols-outlined text-[18px]">chevron_left</span>
</button>
<button class="p-1 rounded-md hover:bg-background-light dark:hover:bg-[#211911] text-text-muted-light dark:text-text-muted-dark">
...
<!-- Post 1 -->
<div class="bg-card-light dark:bg-card-dark rounded-xl overflow-hidden shadow-sm group cursor-pointer border border-border-light dark:border-border-dark hover:border-primary/50 transition-colors">
<div class="h-40 bg-cover bg-center group-hover:scale-105 transition-transform duration-500" data-alt="Volunteer planting a tree in dry soil" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAS0shbuAFNlwkwuJR0zN4_JZW0HwOluvq-x_f-_IqJ3g3HIrBJQMdXOWC9-6JAIdPHRr2Ynyyq2z4N9nwDORA4R-PAfIvNxsFR9YSttgslGGy_EoWH9F-BjJy2dn7k-3ZCQEONtHc6qt5UQzTqkm1j87WhKt3hHqjzg4s5F6FTXzlj54nFFypYDq_ydcq0vhhUbvki46vpb2U7_YbxVd2erSLmKlslneNpPMVyiE2rnm7YYR8bDWgHrgp69aKdsnwftMpUAq-o0y0");'></div>
<div class="p-4">
<div class="flex items-center gap-2 text-xs text-text-muted-light dark:text-text-muted-dark mb-2">
<span class="bg-primary/10 text-primary px-2 py-0.5 rounded-full font-semibold">Environment</span>
<span>•</span>
<span>2 days ago</span>
</div>
<h4 class="font-bold text-base mb-2 group-hover:text-primary transition-colors">New Reforestation Initiative Launches in NSW</h4>
<p class="text-sm text-text-muted-light dark:text-text-muted-dark line-clamp-2">Our latest project aims to plant over 50,000 native trees to restore habitats lost in recent fires.</p>
</div>
</div>
<!-- Post 2 -->
<div class="bg-card-light dark:bg-card-dark rounded-xl overflow-hidden shadow-sm group cursor-pointer border border-border-light dark:border-border-dark hover:border-primary/50 transition-colors">
<div class="h-40 bg-cover bg-center group-hover:scale-105 transition-transform duration-500" data-alt="Happy children receiving food aid" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCAD64zVmYOFjxvSDFQW7EPJM9fLPLiKw00umiUFBE-5GmTtWViqbFIJPpJ9HdQPNyfJhYXymz3IN6AW0fjcRIcTgRtG2hhbyu-a_kuhMmQCTsB1-jjhn4hCVtpzEfq-PLJLybQwTGLTT14Oeah-RtRARSz5GpiNnJTAEfsk6ok4dnByoGbaHs6ta8ShK_Gl2qRu_t_96J8nAyRKf0YF8jwZXTmaHrW3lg4Gna3hplWJ7KhM5AwAKqdk3Ze1ETb1mDyN1fptMZDv0s");'></div>
<div class="p-4">
<div class="flex items-center gap-2 text-xs text-text-muted-light dark:text-text-muted-dark mb-2">
<span class="bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full font-semibold">Community</span>
<span>•</span>
<span>4 days ago</span>
</div>
<h4 class="font-bold text-base mb-2 group-hover:text-primary transition-colors">Food Drive Success: 10,000 Meals Delivered</h4>
<p class="text-sm text-text-muted-light dark:text-text-muted-dark line-clamp-2">Thanks to our amazing volunteers, we've successfully distributed essential food supplies to families in need.</p>
</div>
</div>
<!-- Post 3 -->
<div class="bg-card-light dark:bg-card-dark rounded-xl overflow-hidden shadow-sm group cursor-pointer border border-border-light dark:border-border-dark hover:border-primary/50 transition-colors">
<div class="h-40 bg-cover bg-center group-hover:scale-105 transition-transform duration-500" data-alt="Group of volunteers smiling at camera" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuBbMUUL_4GcED9SoV6enVpy96P7y1GOsrf1X4n2CCNZ0nNZMirzdmo1rGs-xH6H6aPf1EgjM56PwiuT6DtF_B2NPsfi8kC0bk_jWAc6XQuXYk2pRc7HT0-CW3GPV547WhPcFCd5FVWAM9DZ8EZ9XkFSroN3pDdysIyIESE1eGnHpHDXZAPTgutBxyw4k6e9XFqpHsCIUaQGaEoFPJW4vpVtlJxiiTI6s7X5CV41lomO5fZKTP85w6-hPKWFAX0W7p7xLKRiSjOFcuU");'></div>
<div class="p-4">
<div class="flex items-center gap-2 text-xs text-text-muted-light dark:text-text-muted-dark mb-2">
<span class="bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 px-2 py-0.5 rounded-full font-semibold">Volunteers</span>
<span>•</span>
<span>1 week ago</span>
</div>
<h4 class="font-bold text-base mb-2 group-hover:text-primary transition-colors">Volunteer Spotlight: Meet the Heroes</h4>
<p class="text-sm text-text-muted-light dark:text-text-muted-dark line-clamp-2">This month we're highlighting the incredible work of our regional coordinators who go above and beyond.</p>
</div>
</div>
</div>
</div>
