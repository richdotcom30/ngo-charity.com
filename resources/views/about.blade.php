...
<button class="flex h-12 items-center justify-center rounded-full bg-primary px-8 text-base font-bold text-[#152112] transition-transform hover:scale-105">
                            Join Our Mission
                        </button>
<button class="flex h-12 items-center justify-center rounded-full border border-[#406336] bg-[#20321b]/50 backdrop-blur-sm px-8 text-base font-bold text-white transition-colors hover:bg-[#20321b] hover:border-primary">
                            Watch Our Story
                        </button>
</div>
</div>
...
<!-- History Timeline -->
<section class="py-20 bg-surface-dark/30 border-y border-[#2d4625]">
...
<section class="py-20 px-4 lg:px-10 overflow-hidden">
...
<div class="flex flex-col sm:flex-row gap-4 mt-4">
<button class="h-14 rounded-full bg-[#152112] px-10 text-lg font-bold text-white transition-transform hover:scale-105 hover:shadow-xl">
                                    Donate Now
                                </button>
<button class="h-14 rounded-full border-2 border-[#152112] px-10 text-lg font-bold text-[#152112] transition-colors hover:bg-[#152112] hover:text-white">
                                    Become a Volunteer
                                </button>
</div>
</div>
